...
public class KasseFrame extends javax.swing.JFrame {
    ...
    private void verkaufenButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_verkaufenButtonMouseClicked
        ...
        kassenStandAnzeigeLabel.setText(String.valueOf(Integer.parseInt(preisTextField.getText())*Integer.parseInt(anzahlTextField.getText()/*+a*/)));
        verkauftAnzeigeLabel.setText(String.valueOf(Integer.parseInt(anzahlTextField.getText())));
